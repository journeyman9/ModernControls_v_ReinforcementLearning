...
#PARAMS = [0.060, 0.070, 0.080, 0.090, 0.100]
...
plt.tight_layout()
plt.savefig('stat_rms.eps', format='eps', dpi=1000)
...
plt.tight_layout()
ax2[0].legend()
plt.savefig('stat_max.eps', format='eps', dpi=1000)
...
plt.tight_layout()
ax3[0].legend()
plt.savefig('stat_goal.eps', format='eps', dpi=1000)
